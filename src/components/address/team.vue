<template xmlns:v-on="http://www.w3.org/1999/xhtml">
    <div class="set" id="setMain">
        <div class="excelUpload">
            ...
            <div>
                <ul>
                    <li v-if="applyForList.length == 0">暂无数据</li>
                    <li class="list" v-for="(item,index) in applyForList" :key="index">
                        ...
                        <div v-if="item.state == 0" class="applyBut">
                        ...
                        <div v-if="item.state == 1" class="applyFont">
                            已接受
                        </div>
                        <div v-if="item.state == 2" class="applyFont">
                            已拒绝
                        </div>
                        <div v-if="item.state == 3" class="applyFont">
                            已屏蔽
                        </div>
                    </li>
                </ul>
