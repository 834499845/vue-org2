    ...
    <div class="wf-form wf-formsettings">
        <div class="wf-field wf-setting-title">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeInfo" maxlength="10" v-model.trim="title" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div class="wf-field wf-setting-description">
            ...
            <div class="fieldblock">
                <textarea type="text" @input="changeInfo" maxlength="100" v-model.trim="description" style="border-color:#FCB298;border-radius: 4px;"></textarea>
            </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            // },
            changeInfo: function () {
                sessionStorage.setItem('approvalTitle', this.title)
                let obj = {
                    title: this.title,
        ...
        created: function () {
            ...
            if (formMenu !== null) {
                ...
                self.description = formMenu.introduce
            }
            sessionStorage.setItem('approvalTitle', self.title)
        },
    }
</script>