    ...
    <div class="wf-form wf-widgetsettings">
        <div v-if="supportSetting.label" class="wf-field wf-setting-label">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="10" v-model.trim="supportSetting.defaultLable" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.label2" class="wf-field wf-setting-label">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="10" v-model.trim="supportSetting.defaultLable2" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.action" class="wf-field wf-setting-label">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="10" v-model.trim="supportSetting.defaultAction" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.textnote" class="wf-field wf-setting-content">
            ...
            <div class="fieldblock">
                <textarea type="text" @input="changeComponent" maxlength="5000" v-model.trim="supportSetting.defaultProps" style="border-color:#FCB298;border-radius: 4px;">
                    请输入说明文字
                </textarea>
            </div>
        </div>
        <div v-if="supportSetting.placeholder" class="wf-field wf-setting-placeholder">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="20" v-model.trim="supportSetting.defaultProps" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <!-- <div v-if="supportSetting.placeholder2" class="wf-field wf-setting-placeholder">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="20" v-model.trim="supportSetting.defaultProps2" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div> -->
        <!-- <div v-if="supportSetting.href" class="wf-field wf-setting-display">
            ...
            <div class="fieldblock">
                <textarea type="text" @input="changeComponent"  v-model.trim="supportSetting.defaultHref" style="border-color:#FCB298;border-radius: 4px;">
                </textarea>
            </div>
        </div> -->
        <div v-if="supportSetting.dateformat" class="wf-field wf-setting-placeholder">
            ...
            <div class="fieldname">
                <label class="fieldblock">
                    <input type="radio" @change="changeComponent" name="dateformat" v-model.trim="supportSetting.defaultFormat"
                           value="yyyy-MM-dd HH:mm" style="border-color:#FCB298;border-radius: 4px;">
                    <span class="verticalmiddle">年-月-日 时:分</span>
                </label>
                <label class="fieldblock">
                    <input type="radio" @change="changeComponent" name="dateformat" v-model.trim="supportSetting.defaultFormat" value="yyyy-MM-dd" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <!-- <div v-if="supportSetting.uint" class="wf-field wf-setting-placeholder">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" v-model.trim="supportSetting.defaulUint" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div> -->
        <div v-if="supportSetting.defaultOptions" class="wf-field wf-setting-options" >
            ...
            <div
                ...
                <div v-for="(n,index) in supportSetting.defaultOptions" class="fieldblock wf-setting-options" :key="n.text">
                    <input type="text" maxlength="20" v-model.trim="n.text" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <div v-if="supportSetting.important" class="wf-field wf-setting-required">
            ...
            <label class="fieldblock">
                <input type="checkbox" @change="changeComponent" value="1"
                       v-model.trim="supportSetting.defaultImportant" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <!-- <div v-if="supportSetting.translate" class="wf-field wf-setting-conformat">
            ...
            <label class="fieldblock">
                <input type="checkbox" @change="changeComponent" value="1"
                       v-model.trim="supportSetting.defaultTranslate" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <!-- <div v-if="supportSetting.autorekonTime" class="wf-field-group">
            ...
            <div class="wf-field wf-setting-duration">
                <label class="fieldblock">
                    <input type="checkbox" @change="changeComponent" value="1"
                           v-model.trim="supportSetting.defaultAutorekonTime" style="border-color:#FCB298;border-radius: 4px;">
            ...
            <div class="wf-setting-duration-label" v-if="supportSetting.defaultAutorekonTime">
                <div class="wf-field wf-setting-label">
                    ...
                    <div class="fieldblock">
                        <input type="text" maxlength="10" v-model.trim="supportSetting.defaultSubtitle" style="border-color:#FCB298;border-radius: 4px;">
                    </div>
                </div>
            </div>
        ...
        <div v-if="supportSetting.sync" class="wf-field wf-setting-required">
            <div class="fieldname">是否作为审批条件</div>
            <label class="fieldblock">
                <input type="checkbox" @change="changeComponent" value="1"
                       v-model.trim="supportSetting.defaultSync" style="border-color:#FCB298;border-radius: 4px;">
                <span class="verticalmiddle">开启</span>
            </label>
        ...
        <!-- <div v-if="supportSetting.print" class="wf-field wf-setting-print">
            ...
            <label class="fieldblock">
                <input type="checkbox"  @change="changeComponent" value="1" v-model.trim="supportSetting.defaultPrint" style="border-color:#FCB298;border-radius: 4px;">
...
<script>
    export default{
        ...
        created: function () {
            let self = this
            drag.$on("delComponents",function (componentLength){
                if(componentLength == 0){
                    self.supportSetting = false
                }
            })
