    ...
    <div class="addrest">
        <div class="main_left">
            <div class="searchInput">
                ...
                <div>
                    <input maxlength="255" v-model.trim="keyword" type="text" placeholder="搜索" @input="getRequest($event)">
                </div>
            ...
            <div class="ModalsLeft">
                ...
                <div class="ModalsLeftMain ModalsLeftMainCompany">
                    ...
                    <div class="MobileDetail">
                        ...
                        <div v-for="(item,index) in MobileVisibles" class="hideLable" :key="index">
                            ...
                            <input maxlength="20" :disabled="MobileVisibles[index].isPhoneLive" :class="{redInput:MobileVisibles[index].status}" type="text"
                                v-model.trim="MobileVisibles[index].value">
                    ...
                    <div v-for="(item,index) in MobileHides" class="hideLable" :key="index">
                        <span :title="item.cKey">
                            <i class="mustIcon" v-show="item.cKey == '手机号'">*</i>{{item.cKey}}</span>：
                        <input maxlength="20" :disabled="MobileHides[index].isPhoneLive" :class="{redInput:MobileHides[index].status}" type="text"
                            v-model.trim="MobileHides[index].value">
    ...
    export default {
        ...
        created: function () {
            ...
            for (let i = 0; i < this.appIdArr.length; i++) {
                if (this.appIdArr[i].authName == '通讯录') {
        ...
        methods: {
            ...
            bigCompantSave() {
                ...
                if (self.isCompanyGroup == 1) {
                    ...
                    // self.getaddBranchInfo(commitData)
                    //     .then(data => {
                    //         if (data.code == "000000") {
